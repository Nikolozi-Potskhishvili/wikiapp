...
import com.freewiki.wikiapp.WikiAppApplicationTests__TestContext001_ApplicationContextInitializer;
...
public class AotTestContextInitializers__Generated {
  public static Map<String, Supplier<ApplicationContextInitializer<? extends ConfigurableApplicationContext>>> getContextInitializers(
    ...
    map.put("com.freewiki.wikiapp.WikiAppApplicationTests", () -> new WikiAppApplicationTests__TestContext001_ApplicationContextInitializer());
    return map;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializerClasses(
    ...
    map.put("com.freewiki.wikiapp.WikiAppApplicationTests", WikiAppApplicationTests__TestContext001_ApplicationContextInitializer.class);
    return map;
  }
}
