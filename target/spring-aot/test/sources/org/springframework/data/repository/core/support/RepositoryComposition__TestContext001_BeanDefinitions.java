...
public class RepositoryComposition__TestContext001_BeanDefinitions {
  ...
  public static class RepositoryFragments {
    /**
     * Get the bean instance supplier for 'jpa.SectionRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.ArticleRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.HyperlinkRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.ParagraphRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.MyUserRepository.fragments#0'.
     */
