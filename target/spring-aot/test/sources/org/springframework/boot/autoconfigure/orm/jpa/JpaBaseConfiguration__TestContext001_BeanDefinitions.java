...
public class JpaBaseConfiguration__TestContext001_BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("com.freewiki.wikiapp.model.Article", "com.freewiki.wikiapp.model.MyUser", "com.freewiki.wikiapp.model.Paragraph", "com.freewiki.wikiapp.model.Section", "com.freewiki.wikiapp.model.WikiHyperlink");
